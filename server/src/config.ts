...
export interface Config {
  ...
  agentErrorRecoveryEnabled: boolean;
  agentErrorRecoveryMinAgeMs: number;
...
export function loadConfig(): Config {
  ...
  return {
    ...
    agentErrorRecoveryEnabled: process.env.AGENT_ERROR_RECOVERY_ENABLED !== "false",
    agentErrorRecoveryMinAgeMs: Math.max(30000, Number(process.env.AGENT_ERROR_RECOVERY_MIN_AGE_MS) || 120000),
